...
proc searchCode*(client: AsyncGithubClient or GithubClient, query: string, sort: string = "indexed",
...
proc searchCommits*(client: AsyncGithubClient or GithubClient, query: string, sort: string = "",
                 order: string = "desc", page=1, perPage=30): Future[JsonNode] {.multisync.} =
  ## Find Commits
  ## Maximum 100 results per page
...
proc searchIssues*(client: AsyncGithubClient or GithubClient, query: string, sort: string = "",
                 order: string ="desc", page=1, perPage=30): Future[JsonNode] {.multisync.} =
  ## Search For Issues
...
proc searchLabels*(client: AsyncGithubClient or GithubClient, query: string, sort: string = "",
                 order: string = "desc", page=1, perPage=30): Future[JsonNode] {.multisync.} =
...
proc searchRepos*(client: AsyncGithubClient or GithubClient, repoId: int, query: string, sort: string = "",
                 order: string = "desc", page=1, perPage=30): Future[JsonNode] {.multisync.} =
...
proc searchTopics*(client: AsyncGithubClient or GithubClient, query: string, sort: string = "",
                 order: string = "desc", page=1, perPage=30): Future[JsonNode] {.multisync.} =
  ## Search topics
  ## Maximum of 100 results per page
...
proc searchUsers*(client: AsyncGithubClient or GithubClient, query: string, sort: string = "",
                 order: string = "desc", page=1, perPage=30): Future[JsonNode] {.multisync.} =
  ## Find Users
  ## Maximum of 100 results per page
